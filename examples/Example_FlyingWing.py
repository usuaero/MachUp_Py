...
trim_info = muAirplane.pitch_trim(L_target = 0.2,aero_state = aero_state, control_state = control_state, prop_state = prop_state)
print(trim_info)
...
wing_dis,prop_dis = muAirplane.distributions(aero_state = aero_state, control_state = control_state, prop_state = prop_state)

plt.plot(wing_dis["control_points"][:,1][0:160],wing_dis["forces_xyz"][0:160,2]/(0.5*aero_state["rho"]*(aero_state["V_mag"]**2)*wing_dis["area"][0:160]),'^')
